...
int main(int argc, char** argv) {
  if (argc != 6) {
    std::cerr << "Usage: " << argv[0]
              ...
              << " mean.binaryproto labels.txt Test.txt" << std::endl;
    return 1;
  }
  ...
  //read file form TXT
  ifstream testFile(argv[5]);
  //ofstream err;
  //err.open("error.txt", ios::out);
  ofstream f_class0,f_class1;
  f_class0.open("f_class0.txt", ios::out);
  f_class1.open("f_class1.txt", ios::out);
  string strtmp;
...
//              count++;
          //if(abs(predicted_class - current_class) > 5){
          //    cout  << file  << std::endl;
